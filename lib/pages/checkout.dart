...
import 'package:marketplaceflutterapp/pages/charts.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
            ...
            child: ListView(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    children:
                        chartList.map((e) => _productContainer(e)).toList(),
                  ),
                )
              ],
            ),
  ...
  Container _productContainer(Chart chart) {
    FlutterMoneyFormatter fmf =
        FlutterMoneyFormatter(amount: chart.product.price);
